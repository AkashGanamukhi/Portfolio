...
const socials = [
 ...
 {
    icon: <Mail size={20} />,
    href: "mailto:akashganamukhi@gmail.com",
    label: "Email",
    handle: "Akash",
 },
 {
    icon: <Github size={20} />,
    href: "https://github.com/AkashGanamukhi",
    label: "Github",
    handle: "GithubPoseidon",
 },
];
        ...
        <div className=" bg-gradient-to-tl from-zinc-900/0 via-zinc-900 to-zinc-900/0">
            ...
            <div className="container flex items-center justify-center min-h-screen px-4 mx-auto">
                <div className="w-full max-w-4xl">
                    <div className="grid w-full grid-cols-1 gap-8 mx-auto mt-32 sm:mt-0 sm:grid-cols-3 lg:gap-16 mb-8">
                        {socials.map((s, index) => (
                            <Card key={index}>
                                <Link
                                    href={s.href}
